  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved command as @command" do
        ...
        post :create, {:command => { "name" => "invalid value" }}, valid_session
        assigns(:command).should be_a_new(Command)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested command" do
        ...
        Command.any_instance.should_receive(:update_attributes).with({ "name" => "MyString" })
        put :update, {:id => command.to_param, :command => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the command as @command" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Command.any_instance.stub(:save).and_return(false)
        put :update, {:id => command.to_param, :command => { "name" => "invalid value" }}, valid_session
        assigns(:command).should eq(command)
      end
